...
impl GroveDbWrapper {
    ...
    pub fn new_open_existing(
        ...
        // concurrently.
        thread::spawn(move || {
            let storage = grove_db.read().expect("todo").storage();
            ...
            while let Ok(message) = rx.recv() {
                match message {
                    DbMessage::Callback(callback) => {
                        ...
                        // for the duration of the callback.
                        callback(
                            grove_db.write().expect("todo").deref_mut(),
                            transaction.as_ref(),
                            &channel,
                        );
                    }
                    ...
                    // Flush message
                    DbMessage::Flush(callback) => {
                        grove_db.read().expect("todo").flush().unwrap();

                        callback(&channel);
                    }
                    DbMessage::StartTransaction(callback) => {
                        grove_db.write().expect("todo").start_transaction().unwrap();
                        transaction = Some(storage.transaction());
                        callback(&channel);
                    }
                    DbMessage::CommitTransaction(callback) => {
...
impl GroveDbWrapper {
    ...
    pub fn js_open(mut cx: FunctionContext) -> JsResult<JsBox<GroveDbWrapper>> {
    ...
    pub fn js_start_transaction(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    ...
    pub fn js_commit_transaction(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_callback = cx.argument::<JsFunction>(0)?.root(&mut cx);
    ...
    pub fn js_rollback_transaction(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_callback = cx.argument::<JsFunction>(0)?.root(&mut cx);
    ...
    pub fn js_is_transaction_started(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_callback = cx.argument::<JsFunction>(0)?.root(&mut cx);
    ...
    pub fn js_abort_transaction(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_callback = cx.argument::<JsFunction>(0)?.root(&mut cx);
    ...
    pub fn js_get(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    ...
    pub fn js_delete(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_path = cx.argument::<JsArray>(0)?;
        let js_key = cx.argument::<JsBuffer>(1)?;
        let js_using_transaction = cx.argument::<JsBoolean>(2)?;
        let js_callback = cx.argument::<JsFunction>(3)?.root(&mut cx);
    ...
    pub fn js_insert(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        dbg!("UYOOOO");
        let js_path = cx.argument::<JsArray>(0)?;
        let js_key = cx.argument::<JsBuffer>(1)?;
        ...
        // Get the `this` value as a `JsBox<Database>`
        dbg!("YO", cx.this().to_string(&mut cx).unwrap().value(&mut cx));
        let db = cx
            .this()
            .downcast_or_throw::<JsBox<GroveDbWrapper>, _>(&mut cx)?;
    ...
    pub fn js_insert_if_not_exists(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_path = cx.argument::<JsArray>(0)?;
        let js_key = cx.argument::<JsBuffer>(1)?;
        let js_element = cx.argument::<JsObject>(2)?;
        let js_using_transaction = cx.argument::<JsBoolean>(3)?;
    ...
    pub fn js_put_aux(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    ...
    pub fn js_delete_aux(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_key = cx.argument::<JsBuffer>(0)?;
    ...
    pub fn js_get_aux(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_key = cx.argument::<JsBuffer>(0)?;
        let js_using_transaction = cx.argument::<JsBoolean>(1)?;
        let js_callback = cx.argument::<JsFunction>(2)?.root(&mut cx);
    ...
    pub fn js_get_path_query(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    ...
    /// Not implemented
    pub fn js_proof(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        Ok(cx.undefined())
    }
    ...
    /// argument to the function
    pub fn js_flush(mut cx: FunctionContext) -> JsResult<JsUndefined> {
        let js_callback = cx.argument::<JsFunction>(0)?.root(&mut cx);
    ...
    pub fn js_root_hash(mut cx: FunctionContext) -> JsResult<JsUndefined> {
